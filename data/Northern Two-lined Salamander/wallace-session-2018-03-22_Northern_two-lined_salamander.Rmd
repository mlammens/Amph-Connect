...
Record of analysis for *Eurycea bislineata*.
--------------------------------------------
...
results <- spocc::occ(query = "Eurycea bislineata", from = "gbif", limit = 500, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Eurycea bislineata")]]
...
```{r}
selCoords <- data.frame(x = c(-78.8989, -77.4487, -70.3295, -70.769, -79.5141, -78.8989), y = c(42.2415, 43.4019, 42.5013, 40.6606, 40.694, 42.2415))
...
```{r}
projCoords <- data.frame(x = c(-73.9422, -74.0521, -73.2831, -73.2941, -73.9422), y = c(-73.9422, -74.0521, -73.2831, -73.2941, -73.9422))
