...
Record of analysis for *Bufo fowleri*.
---------------------------------------------
...
results <- spocc::occ(query = "Bufo fowleri", from = "gbif", limit = 10000, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Bufo fowleri")]]
...
```{r}
writeRaster(x = proj, filename = "fowlers-toad.asc", overwrite = TRUE)
```
