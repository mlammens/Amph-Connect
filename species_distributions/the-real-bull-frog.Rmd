...
Record of analysis for *Lithobates catesbeianus*.
---------------------------------------------
...
results <- spocc::occ(query = "Lithobates catesbeianus", from = "gbif", limit = 10000, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Lithobates catesbeianus")]]
...
```{r}
writeRaster(x = proj, filename = "bull-frog.asc", overwrite = TRUE)
```
