...
```{r}
selCoords <- data.frame(x = c(-73.4369, -71.7889, -71.4923, -71.4154, -73.2611, -73.4369), y = c(41.1009, 41.3323, 42.2171, 42.9452, 42.7034, 41.1009))
...
Buffer size of the study extent polygon defined as 0.12 km.

```{r}
bgExt <- rgeos::gBuffer(bgExt, width = 0.12)
```
...
```{r}
projCoords <- data.frame(x = c(-74.0555, -74.0445, -73.8467, -73.4457, -73.5611, -73.4952, -74.0555), y = c(-74.0555, -74.0445, -73.8467, -73.4457, -73.5611, -73.4952, -74.0555))
