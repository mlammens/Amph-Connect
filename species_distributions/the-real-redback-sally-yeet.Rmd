...
Record of analysis for *Plethodon cinereus*.
---------------------------------------------
...
results <- spocc::occ(query = "Plethodon cinereus", from = "gbif", limit = 10000, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Plethodon cinereus")]]
...
```{r}
writeRaster(x = proj, filename = "redback-salamander.asc", overwrite = TRUE)
```
