...
Record of analysis for *Ambystoma opacum*.
---------------------------------------------
...
results <- spocc::occ(query = "Ambystoma opacum", from = "gbif", limit = 1000, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Ambystoma opacum")]]
...
```{r}
writeRaster(x = proj, filename = "marbled_salamander.asc", overwrite = TRUE)
```
