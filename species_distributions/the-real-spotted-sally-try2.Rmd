...
results <- spocc::occ(query = "Ambystoma maculatum", from = "gbif", limit = 10000, has_coords = TRUE)
...
e <- ENMeval::ENMevaluate(occs.xy, envsBgMsk, bg.coords = bg.xy, RMvalues = rms, fc = c('LQ', 'LQH'), 
...
```{r}
writeRaster(x = proj, filename = "spotted-salamander.asc", overwrite = TRUE)
```
