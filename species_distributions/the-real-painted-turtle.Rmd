...
Record of analysis for *Chrysemys picta*.
---------------------------------------------
...
results <- spocc::occ(query = "Chrysemys picta", from = "gbif", limit = 10000, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Chrysemys picta")]]
...
```{r}
writeRaster(x = proj, filename = "painted-turtle.asc", overwrite = TRUE)
```
