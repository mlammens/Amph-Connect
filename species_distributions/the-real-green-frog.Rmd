...
Record of analysis for *Lithobates clamitans*.
---------------------------------------------
...
results <- spocc::occ(query = "Lithobates clamitans", from = "gbif", limit = 10000, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Lithobates clamitans")]]
...
```{r}
writeRaster(x = proj, filename = "green-frog.asc", overwrite = TRUE)
```
