...
Record of analysis for *Pseudacris crucifer*.
---------------------------------------------
...
results <- spocc::occ(query = "Pseudacris crucifer", from = "gbif", limit = 10000, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Pseudacris crucifer")]]
...
```{r}
writeRaster(x = proj, filename = "spring-peeper.asc", overwrite = TRUE)
```
