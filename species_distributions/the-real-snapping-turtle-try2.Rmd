...
Record of analysis for *Chelydra serpentina*.
---------------------------------------------

### Obtain Occurrence Data

The search for occurrences was limited to 10000 records. Obtain occurrence records of the selected species from the gbif database.

```{r}
# query selected database for occurrence records
results <- spocc::occ(query = "Chelydra serpentina", from = "gbif", limit = 10000, has_coords = TRUE)
...
```{r}
#projPoly <- rgdal::readOGR(dsn = "/Users/mtier_000/PACE team Dropbox/Michael Tierney/QGIS Files/Aiello-Lammens-Main-Study-Region.shp")
...
```{r}
#writeRaster(x = proj, filename = "/Users/mtier_000/Dropbox/DEC-Estuary-Program-Grant-Execution/species_distributions/the-real-snapping-turtle.asc", overwrite = TRUE)
writeRaster(x = proj, filename = "snapping-turtle.asc", overwrite = TRUE)
