...
Record of analysis for *Hyla versicolor*.
---------------------------------------------
...
results <- spocc::occ(query = "Hyla versicolor", from = "gbif", limit = 10000, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Hyla versicolor")]]
...
```{r}
writeRaster(x = proj, filename = "gray-treefrog.asc", overwrite = TRUE)
```
