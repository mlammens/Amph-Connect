...
Record of analysis for *Bufo americanus*.
---------------------------------------------
...
results <- spocc::occ(query = "Bufo americanus", from = "gbif", limit = 10000, has_coords = TRUE)
# retrieve data table from spocc object
results.data <- results[["gbif"]]$data[[formatSpName("Bufo americanus")]]
...
```{r}
#projPoly <- rgdal::readOGR(dsn = "/Users/mtier_000/Dropbox/QGIS Files/Aiello-Lammens-Main-Study-Region.shp")
...
```{r}
#writeRaster(x = proj, filename = "/Users/mtier_000/Dropbox/DEC-Estuary-Program-Grant-Execution/species_distributions/the-real-american-toad.asc", overwrite = TRUE)
writeRaster(x = proj, filename = "american-toad.asc", overwrite = TRUE)
```
